...
本文档详细阐述了 u-kit 组件库的测试策略、测试工具配置、测试最佳实践和测试流程，确保组件库的质量和稳定性。
...
describe('UButton 样式测试', () => {
  ...
  it('应该在暗黑模式下应用暗黑主题', () => {
    ...
    expect(wrapper.classes()).toContain('u-button--dark');
  });
});
```
